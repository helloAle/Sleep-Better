...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/App` | `/App` | `/(tabs)/Feedback` | `/Feedback` | `/(tabs)/Formulario` | `/Formulario` | `/(tabs)/Home` | `/Home` | `/(tabs)/imagens/Anotações.png` | `/imagens/Anotações.png` | `/(tabs)/imagens/checkin.jpg` | `/imagens/checkin.jpg` | `/(tabs)/imagens/Logo.jpg` | `/imagens/Logo.jpg` | `/(tabs)/imagens/logolegado.png` | `/imagens/logolegado.png` | `/(tabs)/imagens/logonenem.png` | `/imagens/logonenem.png` | `/(tabs)/TabOneScreen` | `/TabOneScreen` | `/(tabs)/TabThreeScreen` | `/TabThreeScreen` | `/(tabs)/TabTwoScreen` | `/TabTwoScreen` | `/(tabs)/_layout` | `/_layout` | `/+html` | `/modal`;
  // prettier-ignore
